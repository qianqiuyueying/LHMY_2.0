...
def can_refund_unredeemed_virtual_voucher(*, redeemed_success_count: int) -> RefundRuleResult:
    """未核销虚拟券退款规则（属性4）。

    说明：
    - redeemed_success_count 指该订单（或该订单的虚拟券权益集合）对应的 SUCCESS 核销记录数量
    """
