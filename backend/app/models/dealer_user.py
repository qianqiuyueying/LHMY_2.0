"""经销商后台账号（DEALER，v1 最小可执行）。

规格来源：
- specs/health-services-platform/design.md -> RBAC：DEALER 账号体系（待补齐阶段）
"""
...
class DealerUser(Base):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, comment="经销商后台账号ID")
    dealer_id: Mapped[str] = mapped_column(String(36), nullable=False, index=True, comment="经销商主体ID")
