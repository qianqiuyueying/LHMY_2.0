"""服务提供方员工账号（PROVIDER_STAFF，v1 最小可执行）。

规格来源：
- specs/health-services-platform/design.md -> RBAC：PROVIDER_STAFF 账号体系（阶段12落地）
"""
...
class ProviderStaff(Base):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, comment="服务提供方员工账号ID")
