...
v1 最小断言：
- 对于任意“未发生 SUCCESS 核销”的虚拟券权益集合，退款规则应允许；
...
from app.services.refund_rules import can_refund_unredeemed_virtual_voucher
...
def test_property_4_unredeemed_refund_rule(redeemed_success_count: int):
    res = can_refund_unredeemed_virtual_voucher(redeemed_success_count=redeemed_success_count)
